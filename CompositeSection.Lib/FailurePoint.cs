...
namespace CompositeSection.Lib
{
    ...
    {
        public FailurePoint(Force force, StrainProfile strain) : this()
        {
            Force = force;
            Strain = strain;
        }

        public FailurePoint(Force force, StrainProfile strain, Point hingPosition, double hingHeight)
        {
            Force = force;
            Strain = strain;
            HingPosition = hingPosition;
            HingHeight = hingHeight;
        }

        public Force Force;

        public StrainProfile Strain;

        public Point HingPosition;
